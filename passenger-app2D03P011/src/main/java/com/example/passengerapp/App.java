...
public class App {
    ...
    public static void main(String[] args) {
        ...
        // Get the PassengerService bean using @Qualifier
        PassengerService passengerService = (PassengerService) context.getBean("passengerService");
        ...
        while (choice != 6) {
            ...
            switch (choice) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    showAllPassengers(passengerService);
                    break;
                case 6:
    ...
    private static void showAllPassengers(PassengerService passengerService) {
